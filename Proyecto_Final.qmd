...
Como estudiantes, sabemos por experiencia propia lo dificil que puede ser mantener un buen rendimiento académico y equilibrar los factores personales, familiares y sociales que influyen en él. Esta experiencia nos motivó a investigar más a fondo qué elementos concretos pueden impactar en las calificaciones de los estudiantes de secundaria, utilizando el conjunto de datos disponible en el portal **UCI Machine Learning Repository.**
...
El código de la app shiny se encuentra en el repositorio como \<\<app\>\> [y aquí está el link](https://gastonnbar.shinyapps.io/ShinyAppCDR/).
