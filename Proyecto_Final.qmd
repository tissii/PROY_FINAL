...
En un primer paso haremos un split con 80% para train y 20% para test, luego crearemos el modelo y lo entrenaremos con los datos del train, para en un ultimo paso predecir sobre los datos del test y hacer las metricas correspondientes.
...
resultados |> head() |> rename(Predicción = .pred) |> kable(caption = "Predicciones del modelo")
```
...
resultados |> head() |> rename(Predicción = .pred_class) |> kable(caption = "Predicciones del modelo")
```
